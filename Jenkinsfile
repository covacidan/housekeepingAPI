pipeline {
    ...
    stages {
        ...
        stage('SonarQube Analysis') {
            steps {
                // Token is auto-generated by Terraform after SonarQube starts
                // and written to Vault — no manual token management required.
                withVault(
                    ...
                    withSonarQubeEnv('SonarQube') {
                        sh """
                            ./mvnw sonar:sonar \
                                -Dsonar.projectKey=housekeeping-api \
                                "-Dsonar.projectName=Housekeeping API" \
